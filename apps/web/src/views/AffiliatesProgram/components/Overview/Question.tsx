    ...
    >
      <Wrapper>
        ...
        <Card>
          ...
          <StyledCardBody>
            <FoldableText title={t('What is the criteria to become a U2Dex affiliate?')} mt="24px">
              ...
              <StyledListText color="textSubtle">{t('Strong understanding of U2Dex and our ecosystem')}</StyledListText>
            </FoldableText>
            <FoldableText title={t('How do I earn commissions as an affiliate?')} mt="24px">
              ...
              <StyledListText ml="16px" color="textSubtle">
                {t('Pairs must be in the U2Dex Token list for the following chains (')}
                <Link
                  external
