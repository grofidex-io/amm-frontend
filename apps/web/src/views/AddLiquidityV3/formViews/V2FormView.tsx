        ...
        {isOneWeiAttack ? (
          <Message variant="warning">
            <Flex flexDirection="column">
              <MessageText>
                {t(
                  'Adding liquidity to this V2 pair is currently not available on GroFi DEX UI. Please follow the instructions to resolve it using blockchain explorer.',
                )}
              </MessageText>
              <LinkExternal
      ...
      <RightContainer>
        <AutoColumn pt="12px" gap="24px">
          <DynamicSection disabled gap="12px">
            <InfoBox message={t('Your position will appear here.')} icon={<BunnyKnownPlaceholder width={140} height={140} />} />
            <RangeSelector
