...
export const useTweetsData = () => {
  return useMemo(() => {
    return [
      {
        tweet: `🐲 Step into the Dragon Lunar Lottery at GroFi DEX! Chase a treasure of 16,000 U2U & an additional $3,880 in USDT prizes! ✨
🧧 Join the celebration: https://app.questn.com/event/869387113325449247
`,
        link: 'https://x.com/GroFi DEX/status/1755252804086628435?s=20',
        date: 'Feb 7',
        like: '1.1k',
        impression: '99.2k',
      },
