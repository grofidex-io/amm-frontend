...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and U2U pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and U2U pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from U2U pool', data)
  }
