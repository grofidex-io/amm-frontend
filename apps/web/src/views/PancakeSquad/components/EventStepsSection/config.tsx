...
const stepsConfigBuilder = ({ t, userInfos, eventInfos, userStatus, account, theme, cakeBalance }: EventStepsType) => {
  ...
  return [
    ...
    },
    {
      ...
      title: t('Hold U2U'),
      bodyText: [t('Each NFT costs U2U to mint. Remember you also need BNB to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"
            href="https://pancakeswap.finance/trade?outputCurrency=0x6d7ce523d59C59De27BB755A1981f4043e79C70E&chainId=56"
            target="_blank"
            width="100%"
          >
            {t('Buy U2U')}
