...
const V3AirdropModal: React.FC = () => {
  ...
  const textDisplay = (): string => {
    if (hasPart1 && hasPart2) {
      return t(
        'You have received an exclusive v3 Legendary and v3 Early Supporter NFT, as well as a U2U airdrop for participating in the GroFi DEX Launch campaign. Claim your reward now and enjoy the benefits of being an early adopter!',
      )
    }
    if (hasPart1) {
      return t(
        'You have received an exclusive v3 Legendary NFT and U2U airdrop for participating in the GroFi DEX Launch campaign. Claim your reward now and enjoy the benefits of being an early adopter!',
      )
    }
    return t(
      'You have received an exclusive v3 Early Supporter NFT and U2U airdrop for participating in the GroFi DEX Launch campaign. Claim your reward now and enjoy the benefits of being an early adopter!',
    )
  }
