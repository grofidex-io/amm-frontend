...
// BNB
export const DEFAULT_INPUT_CURRENCY = 'U2U'
// CAKE
export const DEFAULT_OUTPUT_CURRENCY = '0x6d7ce523d59C59De27BB755A1981f4043e79C70E'
...
export const EXCHANGE_PAGE_PATHS = ['/swap', '/trade','/limit-orders', 'liquidity', '/add', '/find', '/remove', '/stable', '/v2']
