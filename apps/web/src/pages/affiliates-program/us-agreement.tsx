  ...
  return (
    <AffiliatesProgramLayout>
      <Container>
        ...
        <Text as="p">
          (a) <strong>3</strong>% on trading fees paid by your Referrals on U2Dex V2 and U2Dex V3, limited to swap
        ...
        <Text as="p">
          7.3 Any statements you make about U2Dex must reflect your honest opinions, beliefs, or experiences and must
        ...
        <Text as="p">
          13.1 U2Dex reserves the right to terminate this Agreement in its entirety with or without cause, effective
        ...
        <Text as="p">
          13.2 U2Dex, in its sole discretion, reserves the right to suspend or terminate your account and refuse any and
        ...
        <Text as="p">13.3 U2Dex reserves the right to refuse service to anyone for any reason at any time.</Text>
        ...
        <Text as="p">
          (f) Conduct marketing or make any representations of any U2Dex products and services to users in the
