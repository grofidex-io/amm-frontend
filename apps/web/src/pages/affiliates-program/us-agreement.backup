  ...
  return (
    <AffiliatesProgramLayout>
      <Container>
        ...
        <Text as="p">
          (a) <strong>3</strong>% on trading fees paid by your Referrals on GroFi DEX V2 and GroFi DEX V3, limited to swap
        ...
        <Text as="p">3.2 All commissions will be paid out in U2U tokens.</Text>
        <Text as="p">
        ...
        <Text as="p">
          ...
          3.3(a) , we will calculate your commissions in U2U tokens using the prevailing USD price of U2U tokens at
          that time.
        </Text>
        ...
        <Text as="p">
          7.3 Any statements you make about GroFi DEX must reflect your honest opinions, beliefs, or experiences and must
        ...
        <Text as="p">
          13.1 GroFi DEX reserves the right to terminate this Agreement in its entirety with or without cause, effective
        ...
        <Text as="p">
          13.2 GroFi DEX, in its sole discretion, reserves the right to suspend or terminate your account and refuse any and
        ...
        <Text as="p">13.3 GroFi DEX reserves the right to refuse service to anyone for any reason at any time.</Text>
        ...
        <Text as="p">
          (f) Conduct marketing or make any representations of any GroFi DEX products and services to users in the
