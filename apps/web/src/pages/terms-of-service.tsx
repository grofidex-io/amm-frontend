...
const TermsOfService = () => {
  return (
    <Container>
      <Text as="h1">U2Dex Terms of Service</Text>
      ...
      <Text as="p">
        ...
        U2Dex protocol” or the “Protocol”), among other services. The Website is one, but not the exclusive, means of
      ...
      <Text as="p">
        ...
        Chain, Aptos and Ethereum. U2Dex does not control or operate any version of the Protocol on any blockchain
        ...
        pay fees for trades, those fees accrue to liquidity providers for the Protocol. As a general matter, the U2Dex
      ...
      <Text as="p">
        U2Dex owns all intellectual property and other rights in the Website and its contents, including (but not
      ...
      <Text as="p">
        ...
        such as rarity scores, token explorer or token lists (which includes the U2Dex default token list and U2Dex
      ...
      <Text as="p">
        ...
        of any other digital tokens which are transacted on U2Dex.
      </Text>
      <Text as="p">
      ...
      <Text as="p">
        ...
        representation or warranty about the safety or soundness of any cross-chain bridge, including its use for U2Dex
        governance.
      </Text>
      <Text as="p">
      ...
      <Text as="p">
        ...
        as otherwise expressly set forth in the terms of another offer by U2Dex, you will be solely responsible to pay
