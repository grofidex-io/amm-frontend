...
const TermsOfService = () => {
  return (
    <Container>
      <Text as="h1">GroFi DEX Terms of Service</Text>
      ...
      <Text as="p">
        ...
        <Link m="0 4px" display="inline !important" href="https://testnet.u2dex.io/">
      ...
      <Text as="p">
        ...
        GroFi DEX protocol” or the “Protocol”), among other services. The Website is one, but not the exclusive, means of
      ...
      <Text as="p">
        ...
        Chain, Aptos and Ethereum. GroFi DEX does not control or operate any version of the Protocol on any blockchain
        ...
        pay fees for trades, those fees accrue to liquidity providers for the Protocol. As a general matter, the GroFi DEX
      ...
      <Text as="p">
        GroFi DEX owns all intellectual property and other rights in the Website and its contents, including (but not
      ...
      <Text as="p">
        ...
        such as rarity scores, token explorer or token lists (which includes the GroFi DEX default token list and GroFi DEX
      ...
      <Text as="p">
        ...
        of any other digital tokens which are transacted on GroFi DEX.
      </Text>
      <Text as="p">
      ...
      <Text as="p">
        ...
        representation or warranty about the safety or soundness of any cross-chain bridge, including its use for GroFi DEX
        governance.
      </Text>
      <Text as="p">
      ...
      <Text as="p">
        ...
        modifications to the Protocol are generally managed in a community-driven way by holders of the U2U token. No
      ...
      <Text as="p">
        ...
        as otherwise expressly set forth in the terms of another offer by GroFi DEX, you will be solely responsible to pay
