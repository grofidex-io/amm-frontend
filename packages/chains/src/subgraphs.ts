...
export function getV3Subgraphs({ noderealApiKey }: SubgraphParams) {
  return {
    ...
    [ChainId.U2U_NEBULAS]: 'https://subgraph-amm-testnet.grofidex.io/subgraphs/name/amm/grofidex-v1',
...
export function getBlocksSubgraphs({ noderealApiKey }: SubgraphParams) {
  return {
    [ChainId.BSC]: 'https://subgraph-amm-testnet.grofidex.io/subgraphs/name/amm/blocks',
    ...
    [ChainId.U2U_NEBULAS]: 'https://subgraph-amm-testnet.grofidex.io/subgraphs/name/amm/blocks',
  }
}
