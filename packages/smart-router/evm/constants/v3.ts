...
export const MIXED_ROUTE_QUOTER_ADDRESSES = {
  ...
  [ChainId.U2U_NEBULAS]: '0x2b917cc156b9080b076ffeeb3a2fa888b71c47e4',
...
export const V3_QUOTER_ADDRESSES = {
  ...
  [ChainId.U2U_NEBULAS]: '0x4be9f86aafeb191a312539b63d170b931958754d',
} as const satisfies Record<ChainId, Address>
...
export const V3_TICK_LENS_ADDRESSES = {
  ...
  [ChainId.U2U_NEBULAS]: '0xb21e8f625217d0aa88072533fd4dbdc6058aa101',
} as const satisfies Record<ChainId, Address>
